    ...
    "retrieval_materialize_s1c_qrels": _step(
        ...
        [
            ...
            _param(
                ...
                "--output",
                "qrels 输出",
                default="configs/retrieval/fin_ia_0_1_3_s1c_requalified_qrels_v1_0.json",
            ),
        ],
        output_parameters=["output"],
    ),
    "retrieval_run_s1c_ranking_comparison": _step(
        ...
        [
            ...
            _param(
                ...
                "--output",
                "完整评测结果",
                default="configs/retrieval/fin_ia_0_1_3_s1c_ranking_comparison_result_v1_0.json",
            ),
            _param(
                "projection_output",
                "--projection-output",
                "Workbench 安全投影",
                default="configs/runtime/fin_ia_0_1_3_s1c_ranking_workbench_projection_v1_0.json",
            ),
        ],
