...
from retrieval.embedding_runtime import (  # noqa: E402
    load_or_build_bge_m3_cache as _bge_cache,
    load_or_build_qwen_embedding_cache as _qwen_cache,
    local_model_identity as _model_identity,
    sparse_weight_matrix as _sparse_matrix,
)
