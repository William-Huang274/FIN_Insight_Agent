...
### 2026-09-08：新NVIDIA问答反例与完整计算接续修复

新跨公司查数A1在原生任务内5次Flash/73384tokens/0.037801元，六金额/财年来源与正文四比例/两百分点正确，12来源接口可开；但两CALC把比例差数值标成百分点，末段表格/SQL单位措辞不清，故非首轮全对。A2针对这两单位8次Flash/196586tokens/0.088436元，正确创建乘100的两新计算，但暴露旧问答CALC不可回读、迫使重复查数，且新正文误写美元÷1000为百万美元（应÷1000000）。两个原回答/源/失败保留，合计0.126237元，不再付费追绿。
