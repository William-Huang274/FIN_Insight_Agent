...
OUTPUT_PATH = ROOT / (
    ...
    "inventory_observation_v1_6_attempt_r8.json"
)
ATTEMPT_ID = "S1-INTERNAL-EXHIBIT-LINEAGE-CORRECTION-R8"
SUPERSEDES = (
    "configs/releases/fin_ia_0_1_3_s1_internal_candidate_"
...
def main() -> int:
    if OUTPUT_PATH.exists():
        raise RuntimeError("internal_supplemental_candidate_r8_already_exists")
    preflight = run_project_os_preflight(ROOT, run_scope=RUN_SCOPE)
    if preflight.get("status") != "pass":
        raise RuntimeError("internal_supplemental_candidate_r8_preflight_blocked")
    ...
    body.update(
        {
            ...
            "implementation": {
                ...
                "lineage_projection_ref": (
                    "src/sec_agent/s1_internal_candidate_ceiling.py"
                ),
                "materializer_ref": (
                    "scripts/releases/materialize_fin_ia_0_1_3_s1_internal_"
                    "candidate_inventory_observation_v1_6_attempt_r8.py"
                ),
