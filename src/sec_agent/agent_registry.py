...
_AGENT_REGISTRY: list[dict[str, Any]] = [
    ...
    _agent(
        ...
        source_families=["primary_sec_filing", "milvus_semantic"],
    ),
    _agent(
    ...
    _agent(
        ...
        role="Web Evidence Operator",
        description="Executes allowlisted web evidence snapshot requests through source classification, parser, and authority gates.",
        tool_permission="bounded_execute",
        allowed_tools=["web_evidence_snapshot"],
        allowed_data_views=["database_query", "artifact_ref"],
        route_authority="execute_route",
        model_profile="none",
        max_tool_calls=2,
        skill_ids=["shared_evidence_boundary", "evidence_operator_tool_use"],
        input_schema="WebEvidenceOperatorInputV0",
        output_schema="WebEvidenceOperatorObservationV0",
    ...
    _agent(
        ...
        source_families=["primary_sec_filing", "company_authored_unaudited_sec_filing", "company_product_evidence_graph", "milvus_semantic"],
    ),
    _agent(
        agent_id="product_technology_analyst",
        role="Product / Technology Analyst",
        ...
        model_profile="balanced",
        max_tool_calls=0,
        skill_ids=["shared_evidence_boundary", "product_technology_analysis"],
        input_schema="SpecialistAnalystInputV0",
        output_schema="SpecialistAnalystMemoletV0",
        source_families=[
            "company_product_evidence_graph",
