...
def test_current_registry_is_exactly_the_current_product_resources() -> None:
    ...
    assert [row.repo_relative_path for row in registry.resources] == [
        ...
        "configs/retrieval/fin_ia_0_1_3_s1c_hybrid_candidate_runtime_policy_v1_9.json",
        "configs/retrieval/fin_ia_0_1_3_s1_product_material_evidence_runtime_policy_v1_2.json",
        "configs/retrieval/fin_ia_0_1_3_s1c_query_object_fact_route_policy_v1_6.json",
        ...
        "configs/runtime/fin_ia_0_1_3_research_workspace_catalog_v1_6.json",
        ...
        "configs/retrieval/fin_ia_0_1_3_s1_current_product_runtime_binding_policy_v1_14.json",
        ...
        "configs/runtime/fin_ia_0_1_3_current_reviewed_claim_anchor_catalog_v1_7.json",
        "configs/retrieval/fin_ia_0_1_3_s1_dell_current_product_readiness_result_v1_7.json",
        "configs/retrieval/fin_ia_0_1_3_s1_mu_current_product_readiness_result_v1_6.json",
        "configs/retrieval/fin_ia_0_1_3_s1_nvda_current_product_readiness_result_v1_6.json",
...
def _copy_registry_fixture(tmp_path: Path) -> Path:
    ...
    paths = [
        ...
        Path("configs/retrieval/fin_ia_0_1_3_s1_financial_research_kernel_v1_5.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_financial_intent_ontology_v1_4.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1c_hybrid_candidate_runtime_policy_v1_9.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_product_material_evidence_runtime_policy_v1_2.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1c_query_object_fact_route_policy_v1_6.json"),
        ...
        Path("configs/retrieval/fin_ia_0_1_3_s1_vs5_retrieval_need_compiler_policy_v1_3.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1d_source_intake_policy_v1_0.json"),
        Path("configs/runtime/fin_ia_0_1_3_research_workspace_catalog_v1_6.json"),
        ...
        Path("configs/retrieval/fin_ia_0_1_3_s1_current_product_runtime_binding_policy_v1_14.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_source_route_portfolio_policy_v1_1.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_source_strength_and_claim_use_policy_v1_0.json"),
        Path("configs/runtime/fin_ia_current_research_evidence_pack_result_v1_6.json"),
        Path("configs/runtime/fin_ia_0_1_3_current_reviewed_claim_anchor_catalog_v1_7.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_dell_current_product_readiness_result_v1_7.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_mu_current_product_readiness_result_v1_6.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_nvda_current_product_readiness_result_v1_6.json"),
        Path("configs/runtime/fin_ia_0_1_3_current_s1_runtime_binding_receipt_v1_15.json"),
        Path("configs/runtime/fin_ia_0_1_3_current_retrieval_snapshot_v1_4.json"),
