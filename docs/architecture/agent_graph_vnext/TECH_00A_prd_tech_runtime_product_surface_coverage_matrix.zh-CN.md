...
| Hybrid Research Authoring / Protected Narrative | NumericFactView、ProtectedNarrativeDraft、CorrectionObjective、CorrectionClosureReceipt | TECH_04/05/06/08/09/10；跨域合同 38 | 历史 alias/atom/renderer 与 FIN 0.1.3 S2-06 R2 failure | 局部 alias compiler、numeric validator、renderer、correction ledger | Workpaper、memo、report、review diff | `covered_contract / runtime_partial / unified contract not consumed` | 旧规则零散且当前 corrected node 丢失 correction semantics；缺 protected-span runtime、逐 correction closure、anti-template paired quality 与 paid-artifact proof |
...
| Provider-neutral Capability Frontier | ProviderPolicyVersion、ModelCapability、Search/Data/ParserCapability、SelectionDecision | TECH_02、06、08、10 | provider adapters / R56 局部 | `llm_gateway.py`、Tool Registry、source probes | admin provider policy、shadow comparison | `covered_contract / runtime_partial` | provider swap、jurisdiction/license/cost/failure policy 和 non-regression gate 未统一 |
