...
IDENTITY_SQL_PATH = (
    ROOT
    / "src/sec_agent/agent_runtime/sql/001_agent_server_identity_v1_0.sql"
)
REMOTE_CREATE_LIFECYCLE_SQL_PATH = (
    ROOT
    / "src/sec_agent/agent_runtime/sql/002_agent_server_remote_create_lifecycle_v1_1.sql"
)
    ...
    assert postgres_bindings == (
        ...
        },
        {
            ...
            "source": (
                ...
                '001_agent_server_identity_v1_0.sql'
            ),
            "target": (
                "/opt/fin-insight/"
        ...
        },
        {
            ...
            "source": (
                "../../src/sec_agent/agent_runtime/sql/"
                '002_agent_server_remote_create_lifecycle_v1_1.sql'
            ),
            "target": (
                "/opt/fin-insight/"
...
def test_v1_1_installer_routes_only_exact_supported_catalog_states() -> None:
    ...
    assert '001_agent_server_identity_v1_0.sql' in compose
    assert '002_agent_server_remote_create_lifecycle_v1_1.sql' in compose
