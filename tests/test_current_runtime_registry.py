...
def test_current_registry_is_exactly_the_current_product_resources() -> None:
    ...
    assert [row.repo_relative_path for row in registry.resources] == [
        ...
        "configs/runtime/fin_ia_0_1_3_research_workspace_catalog_v1_3.json",
        ...
        "configs/runtime/fin_ia_0_1_3_current_s1_product_readiness_catalog_v1_0.json",
        "configs/retrieval/fin_ia_0_1_3_s1_current_product_runtime_binding_policy_v1_1.json",
        "configs/retrieval/fin_ia_0_1_3_s1d_source_intake_policy_v1_0.json",
        "configs/runtime/fin_ia_current_research_evidence_pack_result_v1_3.json",
        ...
        "configs/retrieval/fin_ia_0_1_3_s1_dell_current_product_readiness_result_v1_1.json",
        "configs/retrieval/fin_ia_0_1_3_s1_mu_current_product_readiness_result_v1_1.json",
        "configs/retrieval/fin_ia_0_1_3_s1_nvda_current_product_readiness_result_v1_1.json",
        "configs/runtime/fin_ia_0_1_3_current_s1_runtime_binding_receipt_v1_1.json",
...
def _copy_registry_fixture(tmp_path: Path) -> Path:
    ...
    paths = [
        ...
        Path("configs/runtime/fin_ia_0_1_3_research_workspace_catalog_v1_3.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_canonical_artifact_spine_policy_v1_0.json"),
        Path("configs/runtime/fin_ia_0_1_3_current_s1_product_readiness_catalog_v1_0.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_current_product_runtime_binding_policy_v1_1.json"),
        Path("configs/runtime/fin_ia_current_research_evidence_pack_result_v1_3.json"),
        Path("configs/runtime/fin_ia_0_1_3_current_reviewed_claim_anchor_catalog_v1_2.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_dell_current_product_readiness_result_v1_1.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_mu_current_product_readiness_result_v1_1.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_nvda_current_product_readiness_result_v1_1.json"),
        Path("configs/runtime/fin_ia_0_1_3_current_s1_runtime_binding_receipt_v1_1.json"),
