...
The calculator resolves archived Pxx:Sxxx source IDs. A newly queried source is readable but is not automatically registered in that calculator; report a concrete calculation-tool gap if needed, never disguise a sourced number as an assumption to bypass binding.
