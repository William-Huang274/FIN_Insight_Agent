...
4. [ ] `S1-08-P2C / S1_08_V3_DELL_R3_SUCCESSOR_CLEAN_ZERO_CALL_PREFLIGHT`：这是当前下一项。先 commit/push，再从 clean archive/fresh process 复现 source SHA、完整 S1-08 contracts、mutation、exact-once 和零外部调用；通过后才另行推进一次 R3 issuance/live scope。
