...
The unfiltered result shows that ticker/year detection and metadata filtering are part of the retrieval problem. Hybrid improves early ranking over full-corpus BM25 and dense, but it does not improve Hit@10 without filters on this seed set.
