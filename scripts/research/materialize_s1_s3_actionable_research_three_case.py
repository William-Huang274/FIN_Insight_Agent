...
DEFAULT_OUTPUT = (
    ...
    / "research"
    / "evals"
    / "fin_ia_0_1_3_s1_s3_actionable_research_three_case_zero_call_result_v1_3.json"
)
...
def _current_binding_projection(
    ...
    if runtime_registry.get("registry_id") != (
        ...
        raise ValueError("three_case_current_registry_R38_required")
...
def materialize(
    *,
    ...
    unsigned = {
        "schema_version": (
            "fin_ia_s1_s3_actionable_research_three_case_zero_call_result_v1_3"
        ),
