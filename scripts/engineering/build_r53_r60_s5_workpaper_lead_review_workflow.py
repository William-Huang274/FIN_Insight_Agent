"""Build S5 Workpaper / Lead Review workflow L4-scope gate artifacts."""
...
def main() -> int:
    ...
    summary = build_s5_gate(root)
    print(json.dumps(summary, ensure_ascii=False, indent=2, sort_keys=True))
    return 0 if summary.get("release_decision") == "S5_L4_scope_pass" else 1
