...
def test_current_registry_is_exactly_the_current_product_resources() -> None:
    ...
    assert [row.repo_relative_path for row in registry.resources] == [
        ...
        "configs/retrieval/fin_ia_0_1_3_s1c_hybrid_candidate_runtime_policy_v1_8.json",
        ...
        "configs/retrieval/fin_ia_0_1_3_s1_current_product_runtime_binding_policy_v1_13.json",
...
def _copy_registry_fixture(tmp_path: Path) -> Path:
    ...
    paths = [
        ...
        Path("configs/retrieval/fin_ia_0_1_3_s1c_hybrid_candidate_runtime_policy_v1_8.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1_product_material_evidence_runtime_policy_v1_2.json"),
        Path("configs/retrieval/fin_ia_0_1_3_s1c_query_object_fact_route_policy_v1_5.json"),
        ...
        Path("configs/retrieval/fin_ia_0_1_3_s1_current_product_runtime_binding_policy_v1_13.json"),
        ...
        Path("configs/runtime/fin_ia_0_1_3_current_s1_runtime_binding_receipt_v1_14.json"),
