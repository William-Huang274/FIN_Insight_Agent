...
OUTPUT_PATH = ROOT / (
    ...
    "bge_fusion_evaluation_attempt_r2.json"
)
...
def main() -> int:
    if OUTPUT_PATH.exists():
        raise RuntimeError("internal_bge_fusion_attempt_r2_already_exists")
    ...
    try:
        ...
        body = {
            "schema_version": (
                ...
                "evaluation_failure_envelope_v1_1"
            ),
            "result_schema_expected": str(policy["result_schema"]),
