...
export function ExecutionPicker({ value, onChange, disabled, action = "research" }: { value: ExecutionOptions; onChange: (v: ExecutionOptions) => void; disabled?: boolean; action?: "research" | "ask" | "revise" }) {
