...
def schema_only_case_convergence_graph():
    ...
    from .model_execution_policy import CASE_REPAIR_PAPERS
    feedback = {p: [] for p in CASE_REPAIR_PAPERS}
