...
from scripts.data_retrieval.build_company_financial_mart import (
...
@pytest.mark.parametrize("protected_output", [root / "nested/result.json" for root in PROTECTED_OUTPUT_ROOTS])
