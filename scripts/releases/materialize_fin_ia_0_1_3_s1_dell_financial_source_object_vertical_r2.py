...
ATTEMPT_ID = "S1-DELL-FINANCIAL-SOURCE-OBJECT-VERTICAL-R2"
SUPERSEDES = (
    "configs/releases/fin_ia_0_1_3_s1_dell_"
...
def main() -> int:
    if OUTPUT_PATH.exists():
        raise RuntimeError("dell_financial_source_object_vertical_r2_result_exists")
    preflight = run_project_os_preflight(ROOT, run_scope=RUN_SCOPE)
    if preflight.get("status") != "pass":
        raise RuntimeError("dell_financial_source_object_vertical_r2_preflight_blocked")
    ...
    body.update(
        {
            ...
            "implementation": {
                ...
                "materializer_ref": (
                    ...
                    "financial_source_object_vertical_r2.py"
                ),
        ...
        json.dumps(
            {
                ...
                "open_required_facets": output["candidate_pack_evaluation"][
