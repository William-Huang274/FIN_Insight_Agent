...
- SEC 下载：`scripts/download_sec_filings.py`
- SEC manifest：`scripts/build_sec_manifest.py`
- SEC chunks：`scripts/build_sec_chunks.py`
- EvidenceObject：`scripts/build_evidence_store.py`
- BM25：`scripts/build_bm25_index.py`
- ObjectBM25：`scripts/build_object_bm25_index.py`
- 8-K 下载：`scripts/download_sec_8k_earnings.py`
- 8-K manifest：`scripts/build_sec_8k_earnings_manifest.py`
- source gap 合并：`scripts/merge_sec_source_gaps.py`
