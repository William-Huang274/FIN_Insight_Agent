...
POLICY_PATH = ROOT / (
    "configs/runtime/fin_ia_0_1_3_s1_internal_candidate_ceiling_policy_v1_3.json"
)
OUTPUT_PATH = ROOT / (
    "configs/releases/fin_ia_0_1_3_s1_internal_candidate_"
    "inventory_observation_v1_3_attempt_r4.json"
)
ATTEMPT_ID = "S1-INTERNAL-LINEAGE-AWARE-ASSET-COMPARATOR-R4"
SUPERSEDES = (
    "configs/releases/fin_ia_0_1_3_s1_internal_candidate_"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Materialize the bounded read-only lineage-aware FIN 0.1.3 internal "
...
def main(argv: list[str] | None = None) -> int:
    ...
    if preflight.get("status") != "pass":
        raise RuntimeError("internal_lineage_asset_comparator_preflight_blocked")
    ...
    body.update(
        {
            ...
            "implementation": {
                ...
                "materializer_ref": (
                    ...
                    "candidate_inventory_observation_v1_3.py"
                ),
    ...
    if target.exists():
        ...
        if existing.get("result_digest") != output["result_digest"]:
            raise RuntimeError("internal_lineage_asset_result_path_already_occupied")
        output = existing
    else:
    ...
    summary = {
        ...
        "lineage_status": output["resource_qualification"]["document_lineage"],
