...
| [Lead 图辅助研究规划](product/lead_graph_research.zh-CN.md) · [工具与测试设计](engineering/lead_graph_planning_evaluation.zh-CN.md) | 从图线索出发的专题规划、图外取证需求、非阻塞质疑与用户决策；设计已记录，未接入或运行新评测 |
