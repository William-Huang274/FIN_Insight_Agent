...
- [ ] D12.1b: Implement SQL / object-store / vector-store schema migrations, artifact-to-database backfill jobs, parity tests, and DB-default readers for remaining D3-D8 / D10 / D11 required stores before allowing full D-series closeout to pass.
- [ ] D12.1c: Switch cross-run agent reads for claim/gap/gate history to DB-default readers after D1/D2/D9 store coverage is accepted beyond per-run parity.
