"""Stdlib parent for the v2.7 clean child; it forwards only exact argv."""
...
CHILD = ROOT / "scripts/engineering/run_point01_m2_a1_actual_audit_clean_child_v2_7.py"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if raw == ["--help"]:
        argparse.ArgumentParser(description="M2-A1 v2.7 approval-lineage parent supervisor.").print_help()
        return 0
    try:
