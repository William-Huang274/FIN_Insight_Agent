...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Search a BM25 evidence index.")
    parser.add_argument("query")
    parser.add_argument("--index-dir", default="data/indexes/bm25/sec_tech_10k")
...
def main() -> None:
    ...
    retriever = BM25Retriever(REPO_ROOT / args.index_dir)
