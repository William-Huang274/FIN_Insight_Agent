        ...
        input_schema=_object_schema(
            {
                ...
                "web_capture_root": {"type": "string"},
                "byte_ceiling": {"type": "integer", "minimum": 1024, "maximum": 16777216},
                "fetch_timeout_s": {"type": "number", "minimum": 1, "maximum": 120},
                "excerpt_chars": {"type": "integer", "minimum": 200, "maximum": 4000},
        ...
        output_schema=_object_schema(
            {
                ...
                "web_scope_policy_ids": _array({"type": "string"}),
                "context_rows": _array({"type": "object"}),
                "evidence_rows": _array({"type": "object"}),
                "request_capture": {"type": "object"},
                "response_capture": {"type": "object"},
                "parser": {"type": "object"},
