...
OUTPUT_PATH = ROOT / (
    "configs/releases/fin_ia_0_1_3_s1_internal_qrels_review_packet_v1_2.json"
)


def main() -> int:
    if OUTPUT_PATH.exists():
        raise RuntimeError("internal_qrels_successor_v1_2_already_exists")
    preflight = run_project_os_preflight(ROOT, run_scope=RUN_SCOPE)
    if preflight.get("status") != "pass":
        raise RuntimeError("internal_qrels_successor_v1_2_preflight_blocked")
