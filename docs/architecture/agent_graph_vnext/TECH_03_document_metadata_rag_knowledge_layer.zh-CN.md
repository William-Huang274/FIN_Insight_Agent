...
R9 working-tree result=`caee03a5...7f3e` 已在不改变 48 条业务 identity 的前提下只修正上述四个角色，分布=`18 instant／10 qtd／8 ytd／12 annual`；无 ticker 分支，9 source-object mutations 与四类新增 presentation-axis fixture 均通过。它在 committed clean proof 前仍不能成为 manifest 输入。
