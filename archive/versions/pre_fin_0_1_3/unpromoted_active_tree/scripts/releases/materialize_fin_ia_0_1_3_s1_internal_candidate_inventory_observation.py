...
OUTPUT_PATH = (
    ROOT
    / "configs/releases/fin_ia_0_1_3_s1_internal_candidate_inventory_observation_v1_0.json"
)


def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Materialize the bounded read-only FIN 0.1.3 internal candidate inventory observation."
    )
    ...
    body.update(
        {
            ...
            "implementation": {
                ...
                "materializer_ref": "scripts/releases/materialize_fin_ia_0_1_3_s1_internal_candidate_inventory_observation.py",
                "policy_ref": "configs/runtime/fin_ia_0_1_3_s1_internal_candidate_ceiling_policy_v1_0.json",
            },
        }
    )
