...
OUTPUT_PATH = ROOT / (
    ...
    "supplemental_asset_manifest_v1_1.json"
)


def main() -> int:
    if OUTPUT_PATH.exists():
        raise RuntimeError("internal_supplemental_asset_manifest_v1_1_already_exists")
    preflight = run_project_os_preflight(ROOT, run_scope=RUN_SCOPE)
    if preflight.get("status") != "pass":
        raise RuntimeError("internal_supplemental_asset_v1_1_preflight_blocked")
