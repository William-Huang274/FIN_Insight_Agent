...
_DATA_BUILD_STEPS = {
    "sec_download_filings": _step(
        ...
        [
            _param("config", "--config", "配置 YAML", default="configs/sources/sec_universe.yaml"),
    ...
    "retrieval_build_current_compiled_object_views": _step(
        ...
        [
            ...
            _param(
                ...
                "--documents",
                "父文档 JSONL",
                default="data/financial-objects/documents.jsonl",
            ),
            _param(
                "records",
                "--records",
                "source-bound child JSONL",
                default="data/financial-objects/records.jsonl",
            ),
            _param(
                "output_dir",
                "--output-dir",
                "私有编译对象目录",
                default="data/compiled-objects",
            ),
            _param(
                "result_output",
                "--result-output",
                "构建摘要",
                default="data/compiled-objects/result.json",
            ),
        ],
    ...
    "financial_facts_build_s2_company_mart": _step(
        ...
        [
            ...
            _param(
                ...
                "私有构建与验收摘要",
                default=(
                    "data/financial-facts/result.json"
                ),
            ),
        ],
    ...
    "industry_download_source_snapshot": _step(
        ...
        [
            _param("contract", "--contract", "行业来源合同", default="configs/sources/industry_apis.yaml"),
            _param("snapshot_id", "--snapshot-id", "快照 ID", required=True),
            _param("as_of_date", "--as-of-date", "截至日期", required=True),
