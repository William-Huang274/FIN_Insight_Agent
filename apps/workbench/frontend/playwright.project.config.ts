...
export default defineConfig({
  testDir:'./e2e',testMatch:['unified-assets.spec.ts','asset-workspace.spec.ts','project-library.spec.ts','project-sec.spec.ts','project-report.spec.ts','project-versions.spec.ts'],workers:1,retries:0,reporter:'list',
