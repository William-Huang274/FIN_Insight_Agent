...
export default function RelationshipRecord({value,onSource}:{value:RecordValue;onSource?:(id:string,passageId?:string)=>void}){
  ...
  return <div className="cw-relationship-record">
    ...
    {onSource&&typeof value.source_id==='string'&&<button onClick={()=>onSource(value.source_id as string,(value.evidence as {passage_id?:string}[]|undefined)?.[0]?.passage_id)}>查看原文依据</button>}
