...
- [x] Public scope and secret-scan contract:
  ...
  - `.gitignore` excludes private/generated paths, including raw retrieval JSON/JSONL/CSV outputs and generated `reports/model_runs/*.json` files.
...
- [x] Final verification before merge:
  ...
  - Local pytest: `83 passed` in the final `main` merge workspace.
