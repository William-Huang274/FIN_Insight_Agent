...
- 当前状态：`preregistered_not_executed`。
...
该预注册记录不等于执行结果、CandidateDecision、Evidence admission、真实补源、proved public-information boundary、G3、S1/S2/S3、研报质量、产品、publication 或 release。
