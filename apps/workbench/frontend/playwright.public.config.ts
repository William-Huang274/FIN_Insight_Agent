...
export default defineConfig({
  testDir: "./e2e",
  testMatch: ["organization-projects.spec.ts", "resource-spaces.spec.ts", "project-workspace.spec.ts", "project-research.spec.ts", "manual-review.spec.ts", "report-versions.spec.ts", "research-graph.spec.ts", "workspace-navigation.spec.ts", "run-workspace.spec.ts", "workspace-refinement.spec.ts", "conversation-workspace.spec.ts", "conversation-memory.spec.ts", "working-notes.spec.ts", "context-editing.spec.ts"],
  retries: 0,
  workers: 1,
  reporter: "list",
