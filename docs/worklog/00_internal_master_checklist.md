...
- [ ] D12.1: Implement actual SQL / object-store schema migrations, artifact-to-database backfill jobs, parity tests, and DB-default readers for D1-D11 required stores before allowing D-series closeout to pass.
