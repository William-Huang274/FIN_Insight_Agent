"""Build a source inventory from validated reviewed evidence."""
...
from sec_agent.agent_runtime.data_access_policy import (
...
def load_reviewed_evidence_enrichment_candidate(
    *,
    ...
    required_by_branch = dict(REQUIRED_SOURCE_FAMILIES_BY_COVERAGE)
...
def load_executable_reviewed_evidence_index_v1_2(
    *,
    ...
    expected_config_sha256: str = DEFAULT_EXPECTED_CONFIG_SHA256,
    expected_enrichment_digest: str = DEFAULT_EXPECTED_ENRICHMENT_DIGEST,
    owner_decision: DataAccessPolicyDecision | None = None,
) -> ReviewedEvidenceIndexV1_2:
    ...
    try:
        decision = validate_trusted_owner_data_gate_decision(
            owner_decision or load_owner_data_gate_decision()
        )
    except DataAccessPolicyError as exc:
...
def load_owner_approved_reviewed_case(
    *,
    ...
    decision = owner_decision or load_owner_data_gate_decision()
