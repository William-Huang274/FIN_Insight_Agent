...
export function ResearchStart({ question, onQuestion, navigate, sessions }: { question: string; onQuestion: (text: string) => void; navigate: (page: string, id?: string) => void; sessions: Session[] }) {
  const ideas = [
