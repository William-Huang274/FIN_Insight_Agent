...
FIN_0_1_2_S4_T05_DELL_CURRENT_EVIDENCE_PROFILE_REF = (
    "fin_0_1_2.s4.t05.research_profile.dell_current_evidence:v1"
)
FIN_0_1_2_S4_T05_MU_CURRENT_EVIDENCE_PROFILE_REF = (
    "fin_0_1_2.s4.t05.research_profile.mu_current_evidence:v1"
)
FIN_0_1_2_S4_T05_NVDA_CURRENT_EVIDENCE_PROFILE_REF = (
    "fin_0_1_2.s4.t05.research_profile.nvda_current_evidence:v1"
)
...
FIN_0_1_2_S4_T05_DELL_CURRENT_EVIDENCE_PROFILE = replace(
    S4_DELL_THREE_CELL_RESEARCH_PROFILE_V3,
    profile_ref=FIN_0_1_2_S4_T05_DELL_CURRENT_EVIDENCE_PROFILE_REF,
)

FIN_0_1_2_S4_T05_MU_CURRENT_EVIDENCE_PROFILE = replace(
    S4_MU_THREE_CELL_RESEARCH_PROFILE,
    profile_ref=FIN_0_1_2_S4_T05_MU_CURRENT_EVIDENCE_PROFILE_REF,
)

FIN_0_1_2_S4_T05_NVDA_CURRENT_EVIDENCE_PROFILE = replace(
    S3_NVDA_THREE_CELL_RESEARCH_PROFILE_V4,
    profile_ref=FIN_0_1_2_S4_T05_NVDA_CURRENT_EVIDENCE_PROFILE_REF,
)
...
_RESEARCH_PROFILES = {
    ...
    FIN_0_1_2_S4_T05_DELL_CURRENT_EVIDENCE_PROFILE.profile_ref: (
        FIN_0_1_2_S4_T05_DELL_CURRENT_EVIDENCE_PROFILE
    ),
    FIN_0_1_2_S4_T05_MU_CURRENT_EVIDENCE_PROFILE.profile_ref: (
        FIN_0_1_2_S4_T05_MU_CURRENT_EVIDENCE_PROFILE
    ),
    FIN_0_1_2_S4_T05_NVDA_CURRENT_EVIDENCE_PROFILE.profile_ref: (
        FIN_0_1_2_S4_T05_NVDA_CURRENT_EVIDENCE_PROFILE
    ),
}
