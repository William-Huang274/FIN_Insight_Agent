...
ATTEMPT_ID = "S1-INTERNAL-EMBEDDED-LINEAGE-FEDERATED-CANDIDATE-GATE-R6"
SUPERSEDES = (
    "configs/releases/fin_ia_0_1_3_s1_internal_candidate_"
...
def main() -> int:
    if OUTPUT_PATH.exists():
        raise RuntimeError("internal_supplemental_candidate_r6_already_exists")
    preflight = run_project_os_preflight(ROOT, run_scope=RUN_SCOPE)
    if preflight.get("status") != "pass":
        raise RuntimeError("internal_supplemental_candidate_r6_preflight_blocked")
    ...
    body.update(
        {
            ...
            "implementation": {
                ...
                "materializer_ref": (
                    ...
                    "candidate_inventory_observation_v1_5.py"
                ),
