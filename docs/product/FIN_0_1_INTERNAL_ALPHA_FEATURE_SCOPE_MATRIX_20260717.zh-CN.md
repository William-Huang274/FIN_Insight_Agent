...
| `P001-F08` | Workpaper / Domain Judgment | 按 decision cells 组织业务/产品、财务、客户/供应链、竞争、资本/price-in、估值边界、风险、counter-thesis 和 WWC | Workpaper | 6.5、B2、9.2 | TECH_05、07、08、09 | 每个核心判断有 evidence refs 或 gap；不是 evidence dump；公司专属 thesis、Numeric 解释、因果/跨 Cell 综合、strongest counter-thesis 和可执行 WWC 通过冻结的研究内容质量 Rubric |
...
| `P001-F15` | Quality / Release Feedback | 显示 Anchor 的 R level、hard blockers、known gaps、review edits、time/tool/model baseline 和 rollback result | Quality / Release Summary | 9.0、10、15 | TECH_10、06、09 | RG1-RG5 可复核；RG3 必须逐案包含研究内容绝对质量、paired material gain 与 qualified human content acceptance；不得把 fixture/legacy/manual supplement 写成 FIN 0.1 能力 |
