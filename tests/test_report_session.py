...
from sec_agent.agent_runtime.report_synthesis_agent import CaseReport, ReportTextEdit, apply_report_edits, report_citations, build_case_output_agent
from sec_agent.agent_runtime.report_session import build_report_session_graph, load_session_materials, ReviewAction, abandoned_question_update
...
def test_abandonment_cannot_skip_report_verification_or_active_work():
    ...
    last = {"status": "error", "metadata": {"surface": 'research_workbench', "human_action": "ask"}}
