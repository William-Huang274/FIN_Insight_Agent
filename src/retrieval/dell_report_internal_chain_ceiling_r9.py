...
from .dell_report_frame_transformation_r9 import (
    FrameTransformationBinding,
    build_frame_transformation_binding_r9,
    build_missing_compiled_frame_binding_r9,
    transformation_binding_digest_r9,
)
from .dell_report_predicate_frames_r9 import (
    TARGET_IDS,
    PredicateFrame,
    classify_package as _classify_predicate_frame_r9,
...
POLICY_SCHEMA_VERSION = "fin_ia_dell_report_internal_chain_ceiling_policy_v1_8"
PRIVATE_RESULT_SCHEMA_VERSION = (
    "fin_ia_dell_report_internal_chain_candidate_ceiling_private_result_v1_8"
)
PUBLIC_RESULT_SCHEMA_VERSION = (
    "fin_ia_dell_report_internal_chain_candidate_ceiling_result_v1_8"
)
ATTEMPT_ID = "dell-rsq-03b-internal-chain-r9"
PROGRAM_ID = "FIN-0.1.3-S1-DELL-RSQ-03B-R9"
BRANCH = r8.BRANCH
POLICY_REF = (
    "configs/retrieval/"
    "fin_ia_0_1_3_s1_dell_03b_internal_chain_candidate_ceiling_policy_v1_8.json"
)
PUBLIC_REF = (
    "configs/retrieval/"
    "fin_ia_0_1_3_s1_dell_03b_internal_chain_candidate_ceiling_result_v1_8.json"
)
PRIVATE_REF = (
...
MIN_FREE_BYTES_BEFORE_ATTEMPT = r8.MIN_FREE_BYTES_BEFORE_ATTEMPT
ZERO_EXECUTION_FIELDS = r8.ZERO_EXECUTION_FIELDS
EXECUTION_CONTRACT = dict(r8.EXECUTION_CONTRACT)
AUTHORITY = dict(r8.AUTHORITY)
SEMANTIC_CONTRACT = {
    **dict(r8.SEMANTIC_CONTRACT),
    "predicate_frame_mode": (
        "punctuation_independent_typed_scope_argument_group_frame_v5"
    ),
    "scope_mode": (
        "frame_local_assertion_owner_actuality_lifecycle_and_scope_edge_v1"
    ),
    "material_coverage_mode": (
        "semantic_signature_and_lossless_frame_transformation_binding_v1"
    ),
}
EXPECTED_IMPLEMENTATION_PATHS = frozenset(
    set(r8.EXPECTED_IMPLEMENTATION_PATHS)
    | {
        "src/retrieval/dell_report_predicate_frames_r9.py",
        "src/retrieval/dell_report_frame_transformation_r9.py",
        "src/retrieval/dell_report_internal_chain_ceiling_r9.py",
        "scripts/data_retrieval/run_dell_report_internal_chain_ceiling_r9.py",
    }
)
...
class DellReportInternalChainCeilingR9Error(ValueError):
    pass


def _require(condition: bool, code: str) -> None:
    if not condition:
        raise DellReportInternalChainCeilingR9Error(code)
...
def validate_dell_report_internal_chain_ceiling_r9_policy(
    ...
    **bound_values: Mapping[str, Any],
    ...
    _require(
        ...
        "dell_03B_R9_policy_output_contract_invalid",
    )
    ...
    _require(
        ...
        "dell_03B_R9_policy_bound_input_population_invalid",
    )
    for binding_id, raw in raw_bound.items():
        ...
        _require(
            ...
            f"dell_03B_R9_policy_bound_input_invalid:{binding_id}",
        )
        supplied = dict(bound_values[binding_id])
        if "result_digest" in row:
            _require(
                supplied.get("result_digest") == row.get("result_digest"),
                f"dell_03B_R9_policy_bound_result_digest_drift:{binding_id}",
            )

    r8_private = _validate_r8_predecessor_result(bound_values["R8_private"])
    _require(
        bound_values["R8_policy"].get("result_digest")
        == r8_private.get("policy_digest")
        and bound_values["R8_public"].get("private_result_digest")
        == r8_private.get("result_digest")
        and bound_values["R8_attempt_receipt"].get("attempt_id")
        == r8.ATTEMPT_ID,
        "dell_03B_R9_R8_predecessor_chain_invalid",
    )
    r8_audit = dict(bound_values["R8_fresh_audit"])
    r17_audit = dict(bound_values["R17_report_audit"])
    _require(
        r8_audit.get("verdicts", {}).get("R8_fresh_qualification") is False
        and r8_audit.get("verdicts", {}).get("new_R8_P0_P1_P2_P3")
        == [0, 0, 3, 0]
    ...
    _require(
        ...
        "dell_03B_R9_policy_execution_identity_invalid",
    )
    ...
    _require(
        ...
        "dell_03B_R9_policy_implementation_binding_population_invalid",
    )
    ...
    _require(
        ...
        "dell_03B_R9_policy_TokenBudgetBasis_invalid",
    )
    _require(
        value.get("authority") == _POLICY_AUTHORITY,
        "dell_03B_R9_policy_authority_invalid",
    )
    return r8_private


def classify_dell_report_internal_chain_r9_package(
    *, target_id: str, text: str, metadata: Mapping[str, Any]
) -> dict[str, Any]:
    return _classify_predicate_frame_r9(
        target_id=target_id,
        text=text,
        metadata=metadata,
    )
...
def build_dell_report_internal_chain_r9_corpus_index(
    *,
    source_rows: Sequence[Mapping[str, Any]],
    object_rows: Sequence[Mapping[str, Any]],
) -> dict[str, Any]:
    return r8.build_dell_report_internal_chain_r8_corpus_index(
        source_rows=source_rows,
        object_rows=object_rows,
    )


def _package_windows_r9(
    *,
    target_id: str,
    ...
    for unit in units:
        ...
        if (
            ...
            continue
        assessment = classify_dell_report_internal_chain_r9_package(
            target_id=target_id,
            text=text,
            metadata=metadata,
        )
...
def _best_package_r9(
    ...
    *,
    ...
    if windows:
        ...
        value = classify_dell_report_internal_chain_r9_package(
...
def _family_transformation_binding_r9(
    *,
    target_id: str,
    family_id: str,
    metadata: Mapping[str, Any],
    ...
    if (
        ...
        return None
    source_frame = source_frame or _selected_frame_r9(
        target_id=target_id,
        package=source_package,
        metadata=metadata,
    )
    compiled_frame = compiled_frame or _selected_frame_r9(
        target_id=target_id,
    ...
    return build_frame_transformation_binding_r9(
        ...
        compiled_window_ids=[f"WINDOW::R9::{value}" for value in object_ids],
...
def _matching_compiled_frame_r9(
    *,
    target_id: str,
...
def _coverage_gap_r9(
    *,
    ...
    return {
        ...
        "anchor_mode": "semantic_signature_transformation_bound_v5",
        "reason": (
...
def assess_dell_report_internal_chain_r9_packages(
    *,
    target_id: str,
    source_rows: Sequence[Mapping[str, Any]],
    object_rows: Sequence[Mapping[str, Any]],
    ...
    index = (
        ...
        else build_dell_report_internal_chain_r9_corpus_index(
            source_rows=source_rows,
            object_rows=object_rows,
        )
    )
    _require(
        ...
        "dell_03B_R9_corpus_index_population_or_position_drift",
    )
    ...
    for family_id in family_ids:
        ...
        if selected is None:
            source_windows = _package_windows_r9(
                target_id=target_id,
            ...
            source_package = _best_package_r9(
                source_windows,
                family_id=family_id,
                metadata=metadata,
        ...
        object_windows = _package_windows_r9(
            target_id=target_id,
        ...
        compiled_package = _best_package_r9(
            object_windows,
            family_id=family_id,
            metadata=metadata,
            object_package=True,
        ...
        if source_package is not None:
            source_frame = _selected_frame_r9(
                target_id=target_id,
                package=source_package,
                metadata=metadata,
            )
            matching_compiled = (
                _matching_compiled_frame_r9(
                    target_id=target_id,
                    source_frame=source_frame,
            ...
            binding = _family_transformation_binding_r9(
                target_id=target_id,
                family_id=family_id,
                metadata=metadata,
            ...
            if binding is None and source_frame is not None:
                binding = build_missing_compiled_frame_binding_r9(
                    canonical_source_family_id=family_id,
    ...
    return {
        ...
        "frame_transformation_binding_digest": (
            transformation_binding_digest_r9(bindings)
        ),
...
def _validate_r8_predecessor_result(
    value: Mapping[str, Any],
) -> dict[str, Any]:
    result = dict(value)
    _require(
        result.get("schema_version") == r8.PRIVATE_RESULT_SCHEMA_VERSION
        and result.get("attempt_id") == r8.ATTEMPT_ID
        ...
        "dell_03B_R9_R8_predecessor_private_identity_invalid",
    )
    return result


def compile_dell_report_internal_chain_ceiling_r9_result(
    *,
    r8_private_result: Mapping[str, Any],
    r9_policy: Mapping[str, Any],
    ...
    """Compile one fresh or explicitly saved execution through the R9 IR."""

    predecessor = _validate_r8_predecessor_result(r8_private_result)
    predecessor_targets = {
    ...
    _require(
        ...
        "dell_03B_R9_R8_predecessor_target_population_invalid",
    )
    ...
    _require(
        ...
        "dell_03B_R9_raw_execution_sha_mismatch",
    )
    request_by_id = validated["request_results_by_id"]
    corpus_index = build_dell_report_internal_chain_r9_corpus_index(
        source_rows=source_rows,
        object_rows=object_rows,
    )
    object_ids = {
    ...
    for target_id in sorted(TARGET_IDS):
        ...
        _require(
            ...
            f"dell_03B_R9_candidate_object_binding_invalid:{target_id}",
        )
        total_union_occurrences += len(union_ids)
        corpus = assess_dell_report_internal_chain_r9_packages(
            target_id=target_id,
            source_rows=source_rows,
            object_rows=object_rows,
        ...
        union = assess_dell_report_internal_chain_r9_packages(
            target_id=target_id,
            source_rows=source_rows,
            object_rows=object_rows,
        ...
        final = assess_dell_report_internal_chain_r9_packages(
            target_id=target_id,
            source_rows=source_rows,
            object_rows=object_rows,
        ...
        target_results.append(
            {
                ...
                "semantic_evidence_unit": (
                    "one_typed_R9_assertion_frame_with_scope_edges_argument_"
                ...
                "candidate_ceiling": {
                    ...
                    "material_anchor_mode": (
                        "semantic_signature_transformation_bound_v5"
                    ),
    ...
    body = {
        ...
        "authority": {
            "03B_R9_execution_consumed": True,
        ...
        "known_boundary": (
            "R9 formal authority permits exactly one fresh local 0.6B query "
            "embedding batch; preview alone may recompile immutable R8 raw "
            "inputs with zero calls. R9 adds punctuation-independent frame "
            "boundaries, frame-local typed semantic state, argument-group price "
            "attachment and explicit source-to-compiled transformation bindings. "
            "It grants no external capture, 4B embedding, reranker, Evidence, "
            "report or product authority."
        ),
        "policy_digest": r9_policy.get("result_digest"),
    }
    return {**body, "result_digest": canonical_digest(body)}


_R9_AUTHORITY_KEYS = frozenset(
    {
        "03B_R9_execution_consumed",
...
_R9_PUBLIC_BINDING_IDS = frozenset(
...
def _public_input_bindings_r9(value: Any) -> dict[str, Any]:
    bindings = _exact_mapping(
        value,
        _R9_PUBLIC_BINDING_IDS,
        "dell_03B_R9_public_input_bindings",
    )
    output: dict[str, Any] = {}
    for binding_id, raw in bindings.items():
        if binding_id == "git_identity":
            row = _exact_mapping(
                ...
                "dell_03B_R9_public_git_identity",
            )
            _require(
                ...
                "dell_03B_R9_public_git_identity_value_invalid",
            )
            ...
            row = _exact_mapping(
                ...
                "dell_03B_R9_public_disk_preflight",
            )
            _require(
                ...
                == MIN_FREE_BYTES_BEFORE_ATTEMPT,
                "dell_03B_R9_public_disk_preflight_value_invalid",
            )
            output[binding_id] = row
        else:
            _require(
                isinstance(raw, Mapping),
                f"dell_03B_R9_public_binding_not_mapping:{binding_id}",
            )
            row = dict(raw)
            _require(
                {"ref", "sha256"}.issubset(row)
                and set(row).issubset(r7._STANDARD_BINDING_KEYS),  # noqa: SLF001
                f"dell_03B_R9_public_binding_unknown_or_missing_key:{binding_id}",
            )
            _require(
                ...
                f"dell_03B_R9_public_binding_value_invalid:{binding_id}",
            )
            output[binding_id] = row
    return output


def build_dell_report_internal_chain_ceiling_r9_public_projection(
    *,
    ...
    _require(
        ...
        "dell_03B_R9_private_projection_identity_invalid",
    )
    _require(
        private_ref == PRIVATE_REF
        and bool(re.fullmatch(r"[0-9a-f]{64}", private_sha256)),
        "dell_03B_R9_private_projection_binding_invalid",
    )
    try:
        target_results = []
        for raw_row in private.get("target_results") or ():
            _require(
                ...
                "dell_03B_R9_public_target_not_mapping",
            )
            row = dict(raw_row)
            ...
            _require(
                ...
                "dell_03B_R9_private_transformation_surface_invalid",
            )
            target_results.append(
                r7._public_target_row(row)  # noqa: SLF001
            )
    except r7.DellReportInternalChainCeilingR7Error as exc:
        raise DellReportInternalChainCeilingR9Error(
            str(exc).replace("dell_03B_R7_", "dell_03B_R9_", 1)
        ) from exc
    _require(
        len(target_results) == len(TARGET_IDS)
        and {str(row["target_id"]) for row in target_results} == set(TARGET_IDS),
        "dell_03B_R9_public_target_population_invalid",
    )
    authority = _exact_mapping(
        private["authority"],
        _R9_AUTHORITY_KEYS,
        "dell_03B_R9_public_authority",
    )
    _require(
        authority.get("03B_R9_execution_consumed") is True
        and all(
            authority.get(key) is False
            for key in _R9_AUTHORITY_KEYS - {"03B_R9_execution_consumed"}
        ),
        "dell_03B_R9_public_authority_value_invalid",
    )
    body = {
        ...
        "input_bindings": _public_input_bindings_r9(private["input_bindings"]),
        "runtime_registry": _exact_mapping(
            private["runtime_registry"],
            r7._RUNTIME_REGISTRY_KEYS,  # noqa: SLF001
            "dell_03B_R9_public_runtime_registry",
        ),
        ...
        "execution_summary": _exact_mapping(
            ...
            "dell_03B_R9_public_execution_summary",
        ),
        "target_results": target_results,
        "summary": _exact_mapping(
            private["summary"],
            r7._SUMMARY_KEYS,  # noqa: SLF001
            "dell_03B_R9_public_summary",
        ),
    ...
    validate_r9_public_tree(body)
    return {**body, "result_digest": canonical_digest(body)}


def validate_r9_public_tree(value: Any) -> None:
