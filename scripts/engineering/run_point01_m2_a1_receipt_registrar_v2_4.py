"""Authority-only registrar for one exact v2.4 M2-A1 receipt.

The registrar owns the v2.4 package directly; it never imports or mutates a
v2.3 entrypoint and cannot materialize runtime/output resources.
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Register one exact v2.4 package-bound receipt without runtime materialization.")
