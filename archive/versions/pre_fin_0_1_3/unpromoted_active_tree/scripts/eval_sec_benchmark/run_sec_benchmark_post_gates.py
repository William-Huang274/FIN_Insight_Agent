...
def main() -> None:
    ...
    _run(
        [
            sys.executable,
            "scripts/eval_sec_benchmark/score_sec_benchmark_outputs.py",
            "--cases-path",
            args.cases_path,
            "--run-dir",
            args.gold_run_dir,
    ...
    if not args.skip_trap_gate:
        ...
        _run(
            [
                sys.executable,
                "scripts/eval_sec_benchmark/validate_trap_refusal_smoke.py",
                "--cases-path",
                args.cases_path,
                "--run-dir",
                trap_run_dir,
    ...
    if args.pipeline_run_dir:
        ...
        if not args.skip_answer_ledger_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_answer_ledger.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--ledger-path",
                    args.ledger_path,
        ...
        if not args.skip_metric_role_term_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_metric_role_terms.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--ledger-path",
                    args.ledger_path,
        ...
        if not args.skip_table_cell_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_table_cells.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--cases-path",
                    args.cases_path,
        ...
        if not args.skip_named_fact_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_named_fact_support.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--cases-path",
                    args.cases_path,
        ...
        if not args.skip_ledger_missing_consistency_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_ledger_missing_consistency.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--ledger-path",
                    args.ledger_path,
        ...
        if not args.skip_abstract_judgment_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_abstract_judgment_rubric.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--cases-path",
                    args.cases_path,
        ...
        if not args.skip_caveat_claim_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_caveat_claims.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--cases-path",
                    args.cases_path,
        ...
        if not args.skip_v2_semantic_contract_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_v2_semantic_contracts.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--cases-path",
                    args.cases_path,
        ...
        if args.judgment_plan_path and not args.skip_answer_vs_judgment_plan_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_answer_vs_judgment_plan.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--judgment-plan-path",
        ...
        if not args.skip_metric_source_grounding_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_sec_benchmark_metric_source_grounding.py",
                    "--run-dir",
                    args.pipeline_run_dir,
                    "--ledger-path",
                    args.ledger_path,
        ...
        if not args.skip_gold_vs_pipeline_gate:
            ...
            _run(
                [
                    sys.executable,
                    "scripts/eval_sec_benchmark/validate_gold_vs_pipeline_gate.py",
                    "--gold-scored-report",
                    str(gold_scored),
    ...
    if not args.skip_ledger_unit_gate:
        ...
        _run(
            [
                sys.executable,
                "scripts/eval_sec_benchmark/validate_sec_benchmark_ledger_units.py",
                "--ledger-path",
                args.ledger_path,
                "--output-path",
