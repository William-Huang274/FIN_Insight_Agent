    ...
    command_specs = [
        {
            ...
            "command": [
                args.python,
                "scripts/eval_context/evaluate_sec_agent_context_state_replay.py",
                "--fixture-root",
        ...
        },
        {
            ...
            "command": [
                args.python,
                "scripts/eval_context/evaluate_sec_agent_context_managed_dispatch_replay.py",
                "--fixture-root",
...
def _run_planner_contract_eval(*, args: argparse.Namespace, reports_root: Path, timeout_s: int) -> dict[str, Any]:
    ...
    generate = _run_subprocess(
        [
            args.python,
            "scripts/eval_query_planner/run_sec_free_query_planner_eval.py",
            "--eval-path",
            str(eval_path),
            "--output-path",
            str(contracts_path),
    ...
    evaluate = _run_subprocess(
        [
            args.python,
            "scripts/eval_query_planner/evaluate_sec_free_query_planner.py",
            "--eval-path",
            str(eval_path),
            "--contracts-path",
            str(contracts_path),
...
def _run_latency_profile(*, args: argparse.Namespace, run_root: Path, timeout_s: int) -> dict[str, Any]:
    ...
    command = [
        args.python,
        "scripts/eval_context/evaluate_sec_agent_latency_profile.py",
        "--case-path",
        str(case_path),
        "--output-path",
        str(output_path),
