...
from sec_agent.agent_runtime import reviewed_evidence_inventory as inventory
...
class TestRealReviewedEvidenceEnrichment:
    ...
    def test_topic_selector_and_minimum_route_are_not_conflated(self) -> None:
        ...
        assert "Q9_COUNTEREVIDENCE_WWC" in broad_release.coverage_obligation_ids
        assert broad_release.proposed_minimum_route_eligible_branch_ids == (
            "Q1_ISSUER_TRUTH",
            "Q2_DEMAND_QUALITY",
            "Q3_UNITS_ASP_PVM",
            "Q5_SUPPLY_AND_PRICE",
