...
def test_current_registry_is_exactly_the_current_product_resources() -> None:
    ...
    assert [row.repo_relative_path for row in registry.resources] == [
        ...
        "configs/retrieval/fin_ia_0_1_3_s1_current_product_runtime_binding_policy_v1_6.json",
        ...
        "configs/runtime/fin_ia_0_1_3_current_s1_runtime_binding_receipt_v1_7.json",
...
def _copy_registry_fixture(tmp_path: Path) -> Path:
    ...
    paths = [
        ...
        Path("configs/retrieval/fin_ia_0_1_3_s1_financial_research_kernel_v1_3.json"),
        ...
        Path("configs/retrieval/fin_ia_0_1_3_s1c_query_object_fact_route_policy_v1_3.json"),
        ...
        Path("configs/retrieval/fin_ia_0_1_3_s1_current_product_runtime_binding_policy_v1_6.json"),
        ...
        Path("configs/runtime/fin_ia_0_1_3_current_s1_runtime_binding_receipt_v1_7.json"),
        Path("configs/runtime/fin_ia_0_1_3_current_retrieval_snapshot_v1_1.json"),
