...
def test_current_registry_is_exactly_the_current_product_resources() -> None:
    ...
    assert registry.registry_id == (
        "FIN-0.1.3-CURRENT-PRODUCT-RUNTIME-RESOURCE-REGISTRY-R27"
    )
    assert [row.repo_relative_path for row in registry.resources] == [
        ...
        "configs/runtime/fin_ia_0_1_3_current_s1_runtime_binding_receipt_v1_4.json",
...
def _copy_registry_fixture(tmp_path: Path) -> Path:
    ...
    paths = [
        ...
        Path("configs/runtime/fin_ia_0_1_3_current_s1_runtime_binding_receipt_v1_4.json"),
