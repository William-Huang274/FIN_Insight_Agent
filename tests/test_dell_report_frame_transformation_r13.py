...
from retrieval.dell_report_frame_transformation_r13 import (
    FrameTransformationBindingR13Error,
    build_frame_transformation_binding_r13,
    transformation_binding_digest_r13,
    validate_frame_transformation_binding_r13,
    validate_predicate_frame_r13_integrity,
)
...
def test_r13_source_compiled_binding_accepts_semantic_equivalence_with_different_representation(
    target_id: str,
    source_text: str,
    compiled_text: str,
) -> None:
    ...
    binding = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::001",
        source_record_id="SOURCE::DELL::R13::001",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::001"],
        compiled_window_ids=["WINDOW::DELL::R13::001"],
    ...
    validate_frame_transformation_binding_r13(binding.as_dict())
...
def test_r13_transformation_diagnostics_and_gate_reject_semantic_role_loss() -> None:
    source = _frame(
        ASP_TARGET,
        "Dell offered PowerEdge hardware for USD 15 in FY2026.",
    )
    ...
    diagnostic = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::002",
        source_record_id="SOURCE::DELL::R13::002",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::002"],
        compiled_window_ids=["WINDOW::DELL::R13::002"],
    ...
    with pytest.raises(
        FrameTransformationBindingR13Error,
        match="R13_transformation_not_lossless",
    ):
        build_frame_transformation_binding_r13(
            canonical_source_family_id="FAMILY::DELL::R13::002",
            source_record_id="SOURCE::DELL::R13::002",
...
def test_r13_relation_loss_rejects_cross_group_product_price_compilation() -> None:
    source = _frame(
        ASP_TARGET,
    ...
    diagnostic = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::RELATION",
        source_record_id="SOURCE::DELL::R13::RELATION",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::RELATION"],
        compiled_window_ids=["WINDOW::DELL::R13::RELATION"],
        compiled_frame=compiled,
        transformation_type="normalized_slice",
        require_lossless=False,
    )
...
def test_r13_price_attachment_proof_type_change_is_semantic_drift() -> None:
    source = _frame(
        ASP_TARGET,
        "Dell offered PowerEdge XE9680 hardware for USD 15.",
    )
    ...
    assert source.semantic_signature_digest != compiled.semantic_signature_digest
    diagnostic = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::PROOF-TYPE",
        source_record_id="SOURCE::DELL::R13::PROOF-TYPE",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::PROOF-TYPE"],
        compiled_window_ids=["WINDOW::DELL::R13::PROOF-TYPE"],
        compiled_frame=compiled,
        transformation_type="normalized_slice",
        require_lossless=False,
    )
...
def test_r13_connector_proof_rebind_for_to_at_is_typed_and_rejected() -> None:
    source = _frame(
        ASP_TARGET,
        "Dell offered PowerEdge XE9680 hardware for USD 15.",
    )
    ...
    diagnostic = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::PROOF-REBIND",
        source_record_id="SOURCE::DELL::R13::PROOF-REBIND",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::PROOF-REBIND"],
        compiled_window_ids=["WINDOW::DELL::R13::PROOF-REBIND"],
        compiled_frame=compiled,
        transformation_type="normalized_slice",
        require_lossless=False,
    )
...
def test_r13_participial_governing_head_cannot_be_compiled_into_direct_price() -> None:
    source = _frame(
        ASP_TARGET,
        "Dell quoted PowerEdge XE9680 hardware at USD 15.",
    )
    compiled = extract_predicate_frames(
        target_id=ASP_TARGET,
        text=(
            "Dell quoted a maintenance service covering PowerEdge XE9680 "
            "hardware at USD 15."
        ),
        metadata=_metadata(),
    )[0]
    assert compiled.accepted is False
    assert compiled.argument_groups[0].governing_nominal_head_class == (
        "structural_product_complement_head"
    )
    diagnostic = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::HEAD-LOSS",
        source_record_id="SOURCE::DELL::R13::HEAD-LOSS",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::HEAD-LOSS"],
        compiled_window_ids=["WINDOW::DELL::R13::HEAD-LOSS"],
        compiled_frame=compiled,
        transformation_type="normalized_slice",
        require_lossless=False,
    )
...
def test_r13_saved_binding_validator_rejects_resigned_proof_rebind() -> None:
    source = _frame(
        ASP_TARGET,
        "Dell offered PowerEdge XE9680 hardware for USD 15.",
    )
    ...
    diagnostic = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::RESIGNED-REBIND",
        source_record_id="SOURCE::DELL::R13::RESIGNED-REBIND",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::RESIGNED-REBIND"],
        compiled_window_ids=["WINDOW::DELL::R13::RESIGNED-REBIND"],
        compiled_frame=compiled,
        transformation_type="normalized_slice",
        require_lossless=False,
    ).as_dict()
    ...
    diagnostic["binding_id"] = (
        "FRAMEBIND::R13::" f"{canonical_digest(core)[:24].upper()}"
    )
    ...
    with pytest.raises(
        FrameTransformationBindingR13Error,
        match="R13_transformation_binding_contains_material_flags",
    ):
        validate_frame_transformation_binding_r13(diagnostic)


def test_r13_clause_ownership_proof_loss_rejects_transformation() -> None:
    source = _frame(
        SUPPLIER_TARGET,
    ...
    assert source.semantic_signature_digest != compiled.semantic_signature_digest
    diagnostic = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::OWNER-PROOF",
        source_record_id="SOURCE::DELL::R13::OWNER-PROOF",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::OWNER-PROOF"],
        compiled_window_ids=["WINDOW::DELL::R13::OWNER-PROOF"],
        compiled_frame=compiled,
        transformation_type="normalized_slice",
        require_lossless=False,
    )
...
def test_r13_equal_proofs_map_provenance_even_when_absolute_spans_shift() -> None:
    source = _frame(
        SUPPLIER_TARGET,
    ...
    assert source.semantic_signature_digest == compiled.semantic_signature_digest
    binding = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::OWNER-MAP",
        source_record_id="SOURCE::DELL::R13::OWNER-MAP",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::OWNER-MAP"],
        compiled_window_ids=["WINDOW::DELL::R13::OWNER-MAP"],
        compiled_frame=compiled,
        transformation_type="bounded_window",
    )
    proof_mapping = next(
...
def test_r13_transformation_recomputes_frame_integrity_before_trusting_digest() -> None:
    frame = _frame(
        SUPPLIER_TARGET,
        "NVIDIA provides GPUs to Dell.",
    )
    validate_predicate_frame_r13_integrity(frame)
    tampered = replace(frame, semantic_signature_digest="0" * 64)
    with pytest.raises(
        FrameTransformationBindingR13Error,
        match="semantic_digest_invalid",
    ):
        validate_predicate_frame_r13_integrity(tampered)


def test_r13_transformation_recomputes_price_attachment_proof_digest() -> None:
    frame = _frame(
        ASP_TARGET,
        "Dell offered PowerEdge XE9680 hardware for USD 15.",
    )
...
def test_r13_transformation_recomputes_clause_ownership_proof_digest() -> None:
    frame = _frame(
        SUPPLIER_TARGET,
        "NVIDIA provides GPUs and in Q2 ships them to Dell.",
    )
...
def test_r13_transformation_binding_set_digest_is_order_independent() -> None:
    source = _frame(
        SUPPLIER_TARGET,
        "Context. NVIDIA provides GPUs to Dell.",
    )
    compiled = _frame(SUPPLIER_TARGET, "NVIDIA provides GPUs to Dell.")
    first = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::003",
        source_record_id="SOURCE::DELL::R13::003",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::003"],
        compiled_window_ids=["WINDOW::DELL::R13::003"],
        compiled_frame=compiled,
        transformation_type="bounded_window",
    )
    second = build_frame_transformation_binding_r13(
        canonical_source_family_id="FAMILY::DELL::R13::004",
        source_record_id="SOURCE::DELL::R13::004",
        source_frame=source,
        compiled_object_ids=["OBJECT::DELL::R13::004"],
        compiled_window_ids=["WINDOW::DELL::R13::004"],
        compiled_frame=compiled,
        transformation_type="many_object_same_source",
    )
    assert transformation_binding_digest_r13([first, second]) == (
        transformation_binding_digest_r13([second, first])
    )
